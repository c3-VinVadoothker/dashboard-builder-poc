...
interface RegionalSalesMapChartProps {
  data: any;
  metadata?: any;
  sizeType: 'small' | 'medium' | 'large';
}

export function RegionalSalesMapChart({ data, metadata, sizeType }: RegionalSalesMapChartProps) {
  ...
  useEffect(() => {
    ...
    locations.forEach((location: any, index: number) => {
      ...
      if (sizeType !== 'small') {
        ...
        ctx.fillText(`$${(location.value / 1000).toFixed(0)}k`, x, y + pointSize + 25);
      }
    });
