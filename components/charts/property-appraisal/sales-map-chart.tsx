...
export function SalesMapChart({ data, metadata, sizeType }: SalesMapChartProps) {
  ...
  useEffect(() => {
    ...
    locations.forEach((location: any, index: number) => {
      ...
      if (sizeType !== 'small') {
        ...
        ctx.fillText(location.value.toFixed(2), x, y + pointSize + 25);
      }
    });
